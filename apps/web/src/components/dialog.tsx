...
>((props, ref) => (
  <PrimitiveDialog.Content
    ...
    {...props}
    className={cn(
      "fixed overflow-hidden top-1/2 left-1/2 max-h-[85vh] z-[100] w-[90vw] max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-xl bg-white p-6 shadow-lg focus:outline-none data-[state=open]:animate-contentShow data-[state=closed]:animate-contentHide",
      props.className
    )}
  />
));
